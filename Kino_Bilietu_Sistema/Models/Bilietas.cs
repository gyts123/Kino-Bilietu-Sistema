...
namespace Kino_Bilietu_Sistema.Models
{
    public class Bilietas
    {
        ...
        public int Rodymo_laikas_id_rodymo_laikas { get; set; }
        ...
        public List<Bilietas> getBilietas()
        {
            ...
            string sqlquery = @"SELECT bilietas.ar_panaudotas, bilietas.amziaus_cenzas, bilietas.ar_užrezervuotas, bilietas.id_Bilietas, rodymo_laikas.laikas, vieta.eiles_nr, vieta.vietos_nr, saskaita.visa_kaina FROM bilietas INNER JOIN rodymo_laikas ON bilietas.fk_Rodymo_laikasid_Rodymo_laikas = rodymo_laikas.id_rodymo_laikas INNER JOIN vieta ON bilietas.fk_Vietaid_Vieta = vieta.id_Vieta INNER JOIN saskaita ON bilietas.fk_Saskaitaid_Saskaita = saskaita.id_Saskaita";
            ...
            foreach (DataRow item in dt.Rows)
            {
                bilietai.Add(new Bilietas
                {
                    ...
                    Rodymo_laikas_id_rodymo_laikas = Convert.ToInt32(item["laikas"]),
